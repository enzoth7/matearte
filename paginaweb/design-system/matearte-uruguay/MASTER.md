...
**Project:** MateArte Uruguay
**Generated:** 2026-08-12 18:54:22
...
|------|-----|--------------|
| Primary / Tinta | `#17130F` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary / Nogal | `#2D1D16` | `--color-secondary` |
| Accent/CTA / Cuero | `#8A5A3B` | `--color-accent` |
| Background / Crema | `#F5EFE3` | `--color-background` |
| Foreground / Tinta | `#17130F` | `--color-foreground` |
| Muted / Alpaca | `#B8B3A8` | `--color-muted` |
| Border / Cuero claro | `#C7A071` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring / Yerba | `#5A653B` | `--color-ring` |

**Color Notes:** Paleta específica de MateArte: tinta, nogal, cuero, cuero claro, yerba, crema y alpaca. No usar rosa, violeta, azul tecnológico ni neón.
...
- **Google Fonts:** [Newsreader + Outfit](https://fonts.google.com/)

**CSS Import:**
```css
/* Loaded with next/font/google: Newsreader + Outfit. */
```
