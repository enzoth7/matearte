...
export function productSeoCopy(product: Product, locale: AppLocale) {
  const titles: Record<AppLocale, Record<string, string>> = {
    es: {
      ...
      "kits-materos": `${product.name} artesanal`,
      cuchillos: `${product.name} artesanal`,
      regalos: `${product.name} personalizado`,
      cintos: `${product.name} de cuero artesanal`,
    ...
    en: {
      ...
      "kits-materos": `${product.name}, handcrafted Uruguayan mate kit`,
      cuchillos: `${product.name}, handcrafted knife`,
      regalos: `${product.name}, personalized Uruguayan gift`,
      cintos: `${product.name}, handcrafted leather belt`,
    ...
    pt: {
      ...
      materas: `${product.name} artesanal`,
      termos: `${product.name} para mate`,
      "kits-materos": `${product.name}, kit de mate uruguaio artesanal`,
      cuchillos: `${product.name}, faca artesanal`,
