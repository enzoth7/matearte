...
export function VariantPanel({ variants }: { variants: ProductVariant[] }) {
  ...
  return (
    <fieldset className="border-y border-black/15 py-6">
      <legend className="text-xs font-semibold tracking-[0.16em] uppercase">Opciones de referencia</legend>
      ...
      <p className="mt-4 text-xs leading-5 text-black/55">Estas opciones son informativas. No representan stock, precio ni una reserva.</p>
    </fieldset>
  );
}
