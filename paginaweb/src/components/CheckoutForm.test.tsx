...
function mockCheckoutFetch(cartPayload = { items: [{ unit_price_minor: 100000, quantity: 1 }], total_weight_grams: 350 }) {
...
describe("CheckoutForm", () => {
  ...
  it("abre la coordinación internacional sólo después de elegir envío a domicilio", async () => {
    ...
    fireEvent.click(screen.getByRole("radio", { name: /coordinar por whatsapp/i }));
