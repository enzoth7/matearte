...
export const products: Product[] = [
  {
    ...
    filterData: { priceUYU: 4500, materials: ["cuero", "otros-metales"], mateType: "imperial" },
    featured: true,
    variants: [
  ...
  },
  {
    ...
    filterData: { priceUYU: 3800, materials: ["cuero", "alpaca"], mateType: "imperial" },
    featured: true,
  ...
  },
  {
    ...
    filterData: { priceUYU: 3200, materials: ["cuero", "otros-metales"], mateType: "criollo" },
    featured: true,
  ...
  },
  {
    ...
    filterData: { priceUYU: 5500, materials: ["cuero", "acero-inoxidable"], mateType: "camionero" },
  ...
  },
  {
    ...
    materials: ["Cuero", "Metal"],
    filterData: { priceUYU: 1200, materials: ["cuero", "otros-metales"], mateType: "torpedo" },
  ...
  },
  {
    ...
    filterData: { priceUYU: 1500, materials: ["acero-inoxidable"] },
    featured: true,
  ...
  },
  {
    ...
    description: "Referencia del catálogo público. La medida elegible se incorporará al completar la ficha comercial.",
    materials: ["Alpaca"],
    filterData: { priceUYU: 2800, materials: ["alpaca"] },
  ...
  },
  {
    ...
    materials: ["Metal"],
    filterData: { materials: ["otros-metales"] },
    variants: [],
  ...
  },
  {
    ...
    description: "Pieza del catálogo público. Los colores se confirmarán al completar la ficha comercial.",
    materials: ["Cuero"],
    filterData: { priceUYU: 5200, materials: ["cuero"] },
    featured: true,
    variants: [{ id: "color", label: "Color", value: "A confirmar" }],
  ...
  },
  {
    ...
    description: "Referencia visual del catálogo público. No representa un precio vigente.",
    materials: ["Cuero"],
    filterData: { priceUYU: 7500, materials: ["cuero"] },
    variants: [{ id: "color", label: "Color", value: "A confirmar" }],
  ...
  },
  {
    ...
    materials: ["Cuero"],
    filterData: { priceUYU: 4200, materials: ["cuero"] },
    variants: [{ id: "color", label: "Color", value: "A confirmar" }],
  ...
  },
  {
    ...
    description: "Referencia visual del catálogo público. El nombre comercial y las variantes deberán validarse al conectar el proveedor.",
    materials: ["Acero inoxidable"],
    filterData: { priceUYU: 4800, materials: ["acero-inoxidable"] },
    featured: true,
    variants: [{ id: "color", label: "Color", value: "A confirmar" }],
  ...
  },
  {
    ...
    materials: ["Acero inoxidable"],
    filterData: { priceUYU: 6800, materials: ["acero-inoxidable"] },
    variants: [{ id: "color", label: "Color", value: "A confirmar" }],
  ...
  },
  {
    ...
    description: "Referencia visual del catálogo. El color y el precio se incorporarán desde la fuente comercial real.",
