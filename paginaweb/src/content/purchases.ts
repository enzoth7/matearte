...
export const purchasePolicies: Record<Locale, Record<"terms" | "privacy" | "purchase" | "shipping", PurchasePolicyContent>> = {
  es: {
    ...
    purchase: {
      ...
      sections: [
        { title: "Productos, precios y disponibilidad", paragraphs: ["Los precios habilitados para compra en Uruguay se expresan en pesos uruguayos. Antes de iniciar el pago, el sistema vuelve a comprobar los artículos, las personalizaciones, el envío y el total."] },
        { title: "Compras en Uruguay", items: ["El pago se gestiona mediante Mercado Pago cuando el comercio está habilitado.", "Un pedido se considera pagado únicamente cuando Mercado Pago confirma la operación al sitio.", "Las opciones de retiro o envío y su costo se muestran antes de ir al pago."] },
  ...
  en: {
    ...
    purchase: {
      ...
      sections: [
        { title: "Products, prices and availability", paragraphs: ["Prices enabled for purchases in Uruguay are expressed in Uruguayan pesos. Before payment begins, the system rechecks items, customizations, shipping and the total."] },
        { title: "Purchases in Uruguay", items: ["Payment is processed through Mercado Pago when commerce is enabled.", "An order is considered paid only after Mercado Pago confirms the transaction to the website.", "Pickup or shipping options and their cost are shown before continuing to payment."] },
  ...
  pt: {
    ...
    purchase: {
      ...
      sections: [
        { title: "Produtos, preços e disponibilidade", paragraphs: ["Os preços habilitados para compra no Uruguai são expressos em pesos uruguaios. Antes de iniciar o pagamento, o sistema verifica novamente os itens, as personalizações, o envio e o total."] },
        { title: "Compras no Uruguai", items: ["O pagamento é processado pelo Mercado Pago quando o comércio está habilitado.", "Um pedido é considerado pago somente quando o Mercado Pago confirma a operação ao site.", "As opções de retirada ou envio e seu custo são exibidos antes de seguir para o pagamento."] },
