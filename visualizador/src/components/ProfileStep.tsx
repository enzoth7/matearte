          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {designs.map((design) => {
                ...
                const price = config.variantId ? getVariantPrice(config.variantId, config.size) : null;
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        {design.fleje_config?.sides?.front?.text && (
                          <p className="text-[11px] text-[#7a4a31] font-bold">
                            Fleje frente: "{design.fleje_config.sides.front.text}"
                          </p>
                        )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
          <div className="w-full max-w-md bg-white border border-[#e7d7c1] rounded-3xl p-6 md:p-8 shadow-2xl space-y-5 relative animate-in fade-in zoom-in duration-150">
            <div className="flex items-center gap-3 text-amber-700 border-b border-[#e7d7c1] pb-3">
              ...
              <h3 className="text-lg font-black text-[#2d1d14] font-serif">Continuar con el borrador</h3>
            </div>
            ...
            <div className="bg-amber-50/90 border border-amber-200 rounded-2xl p-4 text-xs font-semibold text-amber-900 leading-relaxed shadow-inner">
              El checkout actual es una simulación visual y no enviará el pedido a producción.
            </div>

            <p className="text-xs text-[#5f3826]/80 font-medium">
              Vas a cargar el borrador <strong>"{selectedDraftToSubmit.title || 'Mate Custom'}"</strong> y continuar a la pantalla de pago.
            </p>
